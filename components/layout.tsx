...
function Navbar(props: NavbarProps) {
  return (
    <div className="flex justify-center mx-auto max-w-7xl h-16 pt-6">
      <nav>
        <ul
          className="flex rounded-full bg-white/90 px-3 text-sm fontmedium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5
backdrop-blur"
        >
          <NavItem
            title={"About Me"}
    ...
    <footer className="pt-10 px-8 pb-16 border-t">
      <div className="flex justify-between gap-6">
        ...
        <p className="text-sm text-zinc-400">
          © 2023 Rasel Parvej. All rights reserved.
        </p>
      </div>
    </footer>
  );
